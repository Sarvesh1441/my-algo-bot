...
STATE_FILE = "D:\\Angel One Bout\\trade_state.json"
...
# फाईल मधून जुनी पोझिशन लोड करणे (लॅपटॉप बंद झाला तरी डेटा वाचणार)
...
while True:
    try:
        ...
        if spot_data.get("status") and spot_data.get("data") is not None:
            ...
            spot_placeholder.metric(label="📈 NIFTY 50 LIVE PRICE", value=f"₹{spot_price:.2f}")
            
            # --- Waiting Mode ---
            if not st.session_state.in_position:
                with trade_placeholder.container():
